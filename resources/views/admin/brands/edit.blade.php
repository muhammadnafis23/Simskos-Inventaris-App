<x-layouts.app title="Edit Produk">
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-[32px] font-bold text-[#1C1C1E] tracking-tight">Edit Produk</h1>
    </div>
    ...
    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="ios-card p-4 sm:p-5 space-y-4">
        ...
        <div class="ios-card p-4 sm:p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="sale_price" value="{{ old('sale_price', $product->selling_price) }}" required min="0"
                        class="w-full rounded-xl border-black/10 bg-[#F2F2F7] focus:bg-white focus:ring-2 focus:ring-[#114F11]/40 focus:border-[#114F11] text-[15px] px-4 py-2.5">
        ...
        <div class="ios-card p-4 sm:p-5 space-y-3">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3">
            <button type="submit" class="w-full sm:w-auto bg-[#114F11] text-white text-[15px] font-semibold px-6 py-3 rounded-full hover:bg-[#0D3D0D] transition-colors">
                Simpan Perubahan
            </button>
            <a href="{{ route('products.index') }}" class="w-full sm:w-auto text-center text-[15px] font-medium text-[#8E8E93] px-4 py-3">Batal</a>
        </div>
    </form>
