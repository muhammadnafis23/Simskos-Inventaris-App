<x-layouts.app title="Input Stok">
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-[32px] font-bold text-[#1C1C1E] tracking-tight">Input Stok</h1>
        <p class="text-[14px] sm:text-[15px] text-[#8E8E93] mt-1">Catat barang masuk atau keluar untuk produk yang sudah terdaftar</p>
    </div>
    ...
    <div x-data="{
        ...
        <div class="space-y-6">
            ...
            <form method="POST" action="{{ route('stock.store') }}" class="ios-card p-4 sm:p-6 space-y-5">
                @csrf
                ...
                <div class="relative">
                    ...
                    <div @click="isOpen = !isOpen"
                         ...
                         :class="isOpen ? 'ring-2 ring-[#114F11]/40 border-[#114F11]' : 'hover:bg-black/5'">
                        ...
                        <div class="p-3 border-b border-black/5 bg-black/5">
                            <div class="relative flex items-center">
                                ...
                                <input type="text"
                                       ...
                                       autocomplete="off"
                                       class="w-full pl-9 pr-3 py-2 bg-[#F2F2F7] border border-black/10 rounded-lg text-[14px] text-[#1C1C1E] placeholder-[#8E8E93] focus:outline-none focus:ring-2 focus:ring-[#114F11]/40 focus:border-[#114F11]">
                            </div>
                        </div>
        ...
        <div class="ios-card p-4 sm:p-6 mt-6">
            ...
            <template x-if="!currentProduct">
                <div class="py-8 text-center text-[#8E8E93]">
                    <svg class="w-10 h-10 mx-auto mb-2 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
            ...
            <template x-if="currentProduct">
                <div class="space-y-4">
                    <div class="flex items-center gap-4 sm:gap-6 pb-4 border-b border-black/5">
                        ...
                        <div class="min-w-0 flex-1 pl-1">
                            <h4 class="text-[16px] sm:text-[17px] font-bold text-[#1C1C1E] tracking-tight leading-snug" x-text="currentProduct.name"></h4>
                            <p class="text-[12px] sm:text-[13px] text-[#8E8E93] mt-1" x-text="(currentProduct.brand ? currentProduct.brand.name : '') + ' · SKU: ' + currentProduct.sku"></p>
                        </div>
                    </div>
        ...
        @if(isset($recentMovements) && $recentMovements->count() > 0)
            <div class="ios-card p-4 sm:p-5 mt-6">
