<x-layouts.app title="Dashboard">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-[32px] font-bold text-[#1C1C1E] tracking-tight">Dashboard</h1>
        <p class="text-[15px] text-[#8E8E93] mt-1">{{ now()->translatedFormat('l, d F Y') }}</p>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        <div class="ios-card p-5">
            ...
            <p class="text-[26px] font-bold text-[#1C1C1E] tabular-nums">{{ $totalProducts }}</p>
        </div>
        ...
        <div class="ios-card p-5">
            ...
            <p class="text-[26px] font-bold text-[#1C1C1E] tabular-nums">Rp{{ number_format($totalStockValue, 0, ',', '.') }}</p>
        </div>

        <div class="ios-card p-5 col-span-2 md:col-span-1">
            ...
            <p class="text-[26px] font-bold text-[#1C1C1E] tabular-nums">{{ $lowStock->count() }} item</p>
        </div>
    </div>
