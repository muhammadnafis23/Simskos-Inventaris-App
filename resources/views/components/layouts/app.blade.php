...
<head>
    ...
    {{-- Script Inisialisasi Dark Mode (Mencegah kedipan saat refresh) --}}
    <script>
    ...
    <style>
        ...
        /* FIX WARNA TEXT & ICON DI DARK MODE */
        ...
        /* Mengubah Hijau Gelap menjadi Hijau Terang di Dark Mode */
...
<body class="bg-[#F2F2F7] text-[#1C1C1E] antialiased transition-colors duration-200">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        {{-- Sidebar (Lebar diperlebar ke w-72) --}}
        <aside class="md:w-72 md:min-h-screen md:sticky md:top-0 bg-white border-b md:border-b-0 md:border-r border-black/5 transition-colors duration-200">
            
            {{-- Header Sidebar (Logo + SIMSKOS & TOKO KOSMETIK + Dark Mode Icon) --}}
            <div class="px-5 py-5 flex items-center justify-between border-b md:border-b-0 border-black/5">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    {{-- Teks Brand Sejajar & Pas --}}
                    <div class="flex flex-col justify-center min-w-0">
                        <h1 class="text-[17px] font-bold text-[#1C1C1E] dark:text-white leading-none tracking-tight">SIMSKOS</h1>
                ...
                {{-- Tombol Switch Dark Mode (Icon Bulan/Matahari) --}}
            ...
            <nav x-data="{ open: true }" @toggle-sidebar.window="open = !open" :class="open ? 'block' : 'hidden md:block'" class="px-3 pb-6 space-y-6">
                ...
                {{-- Grup Katalog (Tampil untuk Admin & Karyawan) --}}
                <div>
